...
def save_and_replace_fedavg_model(directory, output_path, validation_data, quantization_levels=256):
    ...
    for model_path in model_filenames:
        model_template.save(model_path)  # Save the aggregated weights in place of the original model
...
if __name__ == "__main__":
    ...
    val_loss, val_accuracy, compressed_size = save_and_replace_fedavg_model(directory_path, output_model_path, (x_val, y_val), quantization_levels=256)
